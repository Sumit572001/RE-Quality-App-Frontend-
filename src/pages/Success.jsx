...
const SuccessPage = () => {
  return (
    <div className="page-container bg-white flex flex-col items-center justify-center px-6 text-center">
      <div className="w-24 h-24 bg-[#4B5694]/10 rounded-full flex items-center justify-center mb-6 animate-scale-in">
        <svg className="w-12 h-12 text-[#4B5694]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
